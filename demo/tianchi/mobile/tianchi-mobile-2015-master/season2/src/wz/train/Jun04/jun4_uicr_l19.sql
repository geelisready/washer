drop table if exists jun4_uicr_train_lb19_wz;
create table jun4_uicr_train_lb19_wz as
select
    ...
    last_2_browse_time_span ui_pre2_bws_span,
    ...
    -- 
    pro1_user_beh4, pro1_user_beh3, pro1_user_beh2, pro1_user_beh1,udiff1, 
    uavghour1, 
    -- rate
    upro1_bws_to_buy, upro1_col_to_buy, upro1_crt_to_buy, 
    -- item
    pro1_item_beh4, pro1_item_beh3, pro1_item_beh2, pro1_item_beh1, idiff1, 
    iavghour1, 
    -- rate
    ipro1_bws_to_buy, ipro1_col_to_buy, ipro1_crt_to_buy, 
    -- geo
    pro1_chr4_cnt, pro2_chr4_cnt, pro3_chr4_cnt, pro1_chr3_cnt, pro2_chr3_cnt, 
    pro3_chr3_cnt, pro1_chr2_cnt, pro2_chr2_cnt, pro3_chr2_cnt, pro1_geo_range, 
    pro2_geo_range, pro3_geo_range, 
    -- category rate
    item_carttobuyrate, item_collecttobuyrate, item_browsetobuyrate, 
    item_in_category_buy_rate, item_in_category_cart_rate, 
    ...
    ui_item_collecttobuyrate1_percent_rank, ui_item_collecttobuyrate2_dense_rank,
    ui_item_collecttobuyrate2_percent_rank, ui_item_collecttobuyrate3_dense_rank,
    ui_item_collecttobuyrate3_percent_rank, ui_item_carttobuyrate1_dense_rank, 
    ui_item_carttobuyrate1_percent_rank, ui_item_carttobuyrate2_dense_rank, 
    ui_item_carttobuyrate2_percent_rank, ui_item_carttobuyrate3_dense_rank, 
    ui_item_carttobuyrate3_percent_rank,
    -- user category
    uc1_dense_rank, uc1_percent_rank, ui1_dense_rank, ui1_percent_rank,
    uc2_dense_rank, uc2_percent_rank, ui2_dense_rank, ui2_percent_rank,
    uc_item_in_category_buy_rate_dense_rank, 
    uc_item_in_category_buy_rate_percent_rank, uc_item_carttobuyrate_dense_rank,
    uc_item_carttobuyrate_percent_rank,
    -- special behavior
    user_next1daybuy_num, item_next1daybuy_num, last_all_score, item_buy_cnt, 
    user_buy_cnt, geo_diff_rep, crt_buy_cnt, crt_nobuy_cnt, col_buy_cnt,
    col_nobuy_cnt, bws_buy_cnt, bws_nobuy_cnt, pro1_buyincate_cnt, 
    -- category behavior statstics
    pro1_crtincate_cnt, pro1_colincate_cnt, pro1_bwsincate_cnt, 
    last_browse_score, last_collect_score, last_cart_score, 
    u_last_category_browse_times, 
    -- user behavior statistics
    u_last_all_browse_times, u_last_category_collect_times, 
    u_last_all_collect_times, u_last_category_cart_times, u_last_all_cart_times,
    -- 
    ...
    -- probability
    pro2w_log_prob, pro3w_log_prob, pro4w_log_prob, pro2w_buy_prob,
    pro3w_buy_prob, pro4w_buy_prob, pro2w_buy_times, pro3w_buy_times, 
    pro4w_buy_times, pro2w_log_prob_ui, pro3w_log_prob_ui, pro4w_log_prob_ui,
    pro2w_buy_prob_ui, pro3w_buy_prob_ui, pro4w_buy_prob_ui, pro2w_buy_times_i,
    pro3w_buy_times_i, pro4w_buy_times_i, pro1_beh_incate_drank, 
    pro1_beh_incate_prank, beh_nobuy_drank, beh_nobuy_prank, pro1_buy_times,
    pro1_crt_times, pro1_col_times, pro11_buy_times, pro11_crt_times, 
    pro11_col_times, pro11_bws_times, pro1_buy_times_h, pro1_crt_times_h,
    pro1_col_times_h, pro1_bws_times_h, pro17_buy_times, pro17_crt_times,
    pro17_col_times, pro17_bws_times, u_recent_2d_interact_buy_prob,
    u_recent_3d_interact_buy_prob, u_recent_4d_interact_buy_prob,
    u_recent_5d_interact_buy_prob, u_recent_7d_interact_buy_prob,
    u_recent_15d_interact_buy_prob, u_recent_26d_interact_buy_prob,
    i_recent_2d_interact_buy_prob, i_recent_3d_interact_buy_prob,
    i_recent_4d_interact_buy_prob, i_recent_5d_interact_buy_prob,
    i_recent_7d_interact_buy_prob, i_recent_15d_interact_buy_prob, 
    i_recent_26d_interact_buy_prob, u_pro20_return_rate, i_pro20_return_rate,
    u_pro1_pureact_cnt, u_pro1_pureact_beh1_cnt, u_pro1_pureact_beh2_cnt, 
    u_pro1_pureact_beh3_cnt, u_pro1_pureact_beh4_cnt, u_pro2w_log_prob_inall,
    u_pro3w_log_prob_inall, u_pro4w_log_prob_inall, u_buy_cnt_inall,
    pro2_item_beh4_fix, pro2_item_beh3_fix, pro2_item_beh2_fix,
    pro2_item_beh1_fix, idiff2_fix, iavghour2_fix, ipro2_bws_to_buy_fix,
    ipro2_col_to_buy_fix, ipro2_crt_to_buy_fix, pro2_buyincate_cnt_fix,
    pro2_crtincate_cnt_fix, pro2_colincate_cnt_fix, pro2_bwsincate_cnt_fix,
    user_buy_cnt2_fix, u_buy_cnt2_inall_fix, u_pro2_return_rate_fix,
    pro3_item_beh4_fix, pro3_item_beh3_fix, pro3_item_beh2_fix, 
    pro3_item_beh1_fix, idiff3_fix, iavghour3_fix, ipro3_bws_to_buy_fix,
    ipro3_col_to_buy_fix, ipro3_crt_to_buy_fix, user_buy_cnt3_fix, 
    u_buy_cnt3_inall_fix, u_pro5_return_rate_fix, pro2_user_beh4_fix, 
    pro2_user_beh3_fix, pro2_user_beh2_fix, pro2_user_beh1_fix, udiff2_fix, 
    uavghour2_fix, upro2_bws_to_buy_fix, upro2_col_to_buy_fix,
    upro2_crt_to_buy_fix, item_buy_cnt2_fix, i_pro2_return_rate_fix,
    pro3_user_beh4_fix, pro3_user_beh3_fix, pro3_user_beh2_fix,
    pro3_user_beh1_fix, udiff3_fix, uavghour3_fix, upro3_bws_to_buy_fix,
    upro3_col_to_buy_fix, upro3_crt_to_buy_fix, item_buy_cnt3_fix,
    i_pro5_return_rate_fix, pro3_buy_times_fix, pro3_crt_times_fix,
    pro3_col_times_fix, pro3_bws_times_fix, pro3_buy_times_h_fix,
    pro3_crt_times_h_fix, pro3_col_times_h_fix, pro3_bws_times_h_fix, 
    pro7_buy_times_fix, pro7_crt_times_fix, pro7_col_times_fix, 
    pro7_bws_times_fix, item_browsetobuyrate1_recent3d_fix,
...
from
    19day_combine_fix_new_u_i_rank__0603 a
    left outer join
    jun3_itr_test_18to19_wz b
    ...
    left outer join
    user_item_category_behavior_agg_2014_12_16 e
    on a.user_id=e.user_id and a.item_id=e.item_id
    left outer join
    user_item_category_behavior_agg_2014_12_15 f
