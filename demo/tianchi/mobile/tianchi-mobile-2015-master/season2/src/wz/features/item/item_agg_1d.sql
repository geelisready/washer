...
drop table if exists item_agg_2014_12_18_wz;
create table item_agg_2014_12_18_wz as 
select 
    item_id,
    -- count
...
drop table if exists item_agg_2014_12_17_wz;
create table item_agg_2014_12_17_wz as 
select 
    item_id,
    -- count
    sum(case when behavior_type=1 then 1 else 0 end) bws_cnt,
...
drop table if exists item_agg_2014_12_16_wz;
create table item_agg_2014_12_16_wz as 
select 
    item_id,
    -- count
    sum(case when behavior_type=1 then 1 else 0 end) bws_cnt,
...
drop table if exists item_agg_2014_12_15_wz;
create table item_agg_2014_12_15_wz as 
select 
    item_id,
    -- count
    sum(case when behavior_type=1 then 1 else 0 end) bws_cnt,
...
drop table if exists item_agg_2014_12_14_wz;
create table item_agg_2014_12_14_wz as 
select 
    item_id,
    -- count
    sum(case when behavior_type=1 then 1 else 0 end) bws_cnt,
...
drop table if exists item_agg_2014_12_13_wz;
create table item_agg_2014_12_13_wz as 
select 
    item_id,
    -- count
    sum(case when behavior_type=1 then 1 else 0 end) bws_cnt,
