...
drop table if exists uc_next1day_buy_num_bf_17_zhgm;
create table uc_next1day_buy_num_bf_17_zhgm as 
 select user_id,item_category,
sum(case when time >= substr(cast(dateadd(cast(concat('2014-12-17',' 00:00:00') as datetime),-3,'dd') as string), 1, 10) then u_buy_dist_i_num_inc 
else 0 end) as uc_next1day_buynum2_recent3d, 

sum(case when time >= substr(cast(dateadd(cast(concat('2014-12-17',' 00:00:00') as datetime),-4,'dd') as string), 1, 10) then u_buy_dist_i_num_inc 
else 0 end) as uc_next1day_buynum2_recent4d, 

sum(case when time >= substr(cast(dateadd(cast(concat('2014-12-17',' 00:00:00') as datetime),-9,'dd') as string), 1, 10) then u_buy_dist_i_num_inc 
else 0 end) as uc_next1day_buynum2_recent9d, ----包含了1212 1211  

sum(case when time >= substr(cast(dateadd(cast(concat('2014-12-17',' 00:00:00') as datetime),-14,'dd') as string), 1, 10) then u_buy_dist_i_num_inc 
else 0 end) as uc_next1day_buynum2_recent14d, 

sum(case when time >= substr(cast(dateadd(cast(concat('2014-12-17',' 00:00:00') as datetime),-21,'dd') as string), 1, 10) then u_buy_dist_i_num_inc 
else 0 end) as uc_next1day_buynum2_recent21d,

sum(case when time >= substr(cast(dateadd(cast(concat('2014-12-17',' 00:00:00') as datetime),-26,'dd') as string), 1, 10) then u_buy_dist_i_num_inc 
...
drop table if exists uc_next1day_buy_num_bf_17_zhgm_l;
create table uc_next1day_buy_num_bf_17_zhgm_l as 
 select t.*,
 ...
 from uc_next1day_buy_num_bf_17_zhgm t;
  
drop table if exists uc_next1day_buy_num_bf_17_zhgm;
create table uc_next1day_buy_num_bf_17_zhgm as 
select * from uc_next1day_buy_num_bf_17_zhgm_l;
...
) all_uc left outer join uc_next1day_buy_num_bf_17_zhgm_l t
