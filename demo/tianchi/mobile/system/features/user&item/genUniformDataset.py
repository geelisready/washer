...
def featExtract(df, featTimeList, labelTimeList):
	...
	featureSet = pd.merge(featureSet, feat_meanAccessTimeAndScalaTime, on = 'item')
	# pdb.set_trace()
...
def featExtract_noLabel(df, featTimeList, labelTimeList):
	...
	feat_Weekday = timeFeat.createWeekdayFeat(itemList = uidList,
												date = labelTimeList[0])
	feat_meanAccessTimeAndScalaTime = timeFeat.createMeanTiAndScalaTimeFeat(
											df_days,
											featCol = 'behavior_type', 
...
def main_offline():
	...
	featTimeList = ['2014-12-07', '2014-12-08', '2014-12-09', '2014-12-10']
	labelTimeList = ['2014-12-11']
